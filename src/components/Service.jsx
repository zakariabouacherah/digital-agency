...
const Service = ({ icon, title, description, onClick }) => {
  ...
  return (
    <div
      onClick={onClick}
      className="relative bg-[#ddd3] px-4 pt-4 flex flex-col items-center justify-start w-full min-h-[400px]  rounded-lg cursor-pointer hover:bg-gradient-to-b from-40% hover:from-[#ff5f1f] hover:to-[#ff814f4b] hover:-translate-y-2 parent "
    >
